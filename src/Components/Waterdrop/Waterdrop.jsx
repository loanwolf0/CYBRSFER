...
const Waterdrop = () => {
  return (
    <div className="main-water">
      <h2 className="text-xl md:text-4xl md:w-auto mb-5 w-[80%] text-center  font-bold p-2 md:p-6 rounded-xl bg-[rgba(0,0,0,0.075)]"> <span className='text-[rgb(254,192,71)]'>This</span>  is What We <span className='text-[rgb(104,68,202)]' > Offer !</span>  </h2>
    <div className='container'>
      <div className="drop" style={{ '--clr': '#ff0f5b' }}>
        <div className="content">
          <h2 id='a'>01</h2>
          <p>Our developers at CYBRSFER specialize in crafting interactive, scalable, brand-focused web solutions for clients. Our goal is to build profitable digital products that spark creativity and boost ROI</p>
          <a href="/">Read More</a>
        </div>
      </div>
